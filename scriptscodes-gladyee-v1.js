...
! function(t) {
	t(".data-snippet").each(function() {
		...
		t("body").hasClass("blog-classic") ? t.get(a.attr("data-post"), function(e) {
			a.html("<span>" + t(e).find(".post-body").text().substr(0, 300) +
				" ...</span>")
...
$(document).ready(function() {
	(function(e) {
		...
		e.get(t.attr("href"), function(n) {
			t.html(
				' <strong><i class="fa fa-angle-right"></i> Next</strong><br/><div class="post-pager-title"><span>' +
				e(n).find(".post .post-title").text() + '</span></div>')
		}, "html");
		e.get(n.attr("href"), function(t) {
			n.html(
				'<strong>Previous <i class="fa fa-angle-left"></i></strong><br/><div class="post-pager-title"><span>' +
...
$(".FollowByEmail .widget-content").after("<div class='email-icon'><i class='fa fa-envelope fa-lg'/></div>");
...
//<![CDATA[
// Image Transition
var scroll="yes",Fscroll=scroll.replace(/(\r\n|\n|\r)/gm," ");"yes"===Fscroll&&($(document).ready(function(){$("body").addClass("imgani")}),$(window).bind("load resize scroll",function(){var o=$(this).height();$(".post-body img, .widget-content img").each(function(){var s=.1*$(this).height()-o+$(this).offset().top;$(document).scrollTop()>s&&$(this).addClass("anime")})}));
//]]>



//<![CDATA[
function darkMode(){localStorage.setItem("mode","darkmode"===localStorage.getItem("mode")?"light":"darkmode"),"darkmode"===localStorage.getItem("mode")?document.querySelector("body").classList.add("dark-skin"):document.querySelector("body").classList.remove("dark-skin")};
(localStorage.getItem('mode')) === 'darkmode' ? document.querySelector('body').classList.add('dark-skin') : document.querySelector('body').classList.remove('dark-skin') 
//]]>
    

/*<![CDATA[*/
function get_text(el) {ret = ""; var length = el.childNodes.length; for(var i = 0; i < length; i++) {var node = el.childNodes[i]; if(node.nodeType != 8) {ret += node.nodeType != 1 ? node.nodeValue : get_text(node);} } return ret;} var words = get_text(document.querySelector('.post-body')); var count = words.split(' ').length; var avg = 155; var counted = count / avg; var maincount = Math.round(counted); document.querySelector(".readTime").innerHTML = maincount + " minute read";
/*]]>*/  
